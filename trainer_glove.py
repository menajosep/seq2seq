...
model_checkpoint = ModelCheckpoint('data/kp20k/{:}.epoch{{epoch:02d}}-val{{val_loss:.5f}}_glove.hdf5'.format(script_name_base),
                                   save_best_only=True)
...
#save model
seq2seq_Model.save('data/kp20k/seq2seq_model_tutorial_glove.hdf5')
